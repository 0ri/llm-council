...
The `chairman` field is optional. If omitted, the #1 ranked model from Stage 2 is automatically selected as chairman. If an explicit chairman fails, the #1 ranked model is used as fallback.
